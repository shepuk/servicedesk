...
<template>
    <div>
        ...
        <Link v-else :href="href" class="block px-4 py-2 text-sm leading-5 text-zinc-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
            <slot />
        </Link>
    </div>
</template>
